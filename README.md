...
<h3> 📊 Detailed Data Collection Chart </h3>
The purpose of this chart is to quantify the data which needs to be collected in order to provide the website owner with the nessacary information to conduct business and provide services as succinctly, and efficiently as possible. 


| **Feature** | **Data Field**             | **Type**           | **Purpose**                                                          |
| ----------- | -------------------------- | ------------------ | -------------------------------------------------------------------- |
| **Classes** | Full Name                  | Text               | Identify student or guardian                                         |
|             | Email Address              | Email              | Communication                                                        |
|             | Phone Number               | Text (optional)    | Alternative contact method (SMS, WhatsApp)                           |
|             | Class Type                 | Choice (4 options) | Afterschool Club, Private Lessons, Business English, Test Prep       |
|             | Preferred Days/Times       | Multi-select       | Match student with available slots                                   |
|             | Age / Child's Age          | Integer            | Place student in appropriate class (especially for afterschool club) |
|             | Language Level             | Choice/Text        | Match with appropriate materials/instructor                          |
|             | Location                   | Text / Dropdown    | If classes are in-person, determine where they are needed            |
|             | Notes / Learning Goals     | Text area          | Personalization of lessons                                           |
|             | How did you hear about us? | Choice/Text        | Marketing insights                                                   |
| **Blog** | Article Title | Text | Display content |
| | Author | Text / FK User | Attribution |
| | Tags / Categories | Multi-select | Organize topics |
| | Publication Date | DateTime | Schedule and archive sorting |
| | Number of Views | Integer (auto) | Track engagement |
| | Likes / Reactions | Integer | Measure post popularity |
| | Comments | Text + Meta | Engagement, feedback |
| | Share Count | Integer (auto) | Measure outreach |
| **Newsletter** | Full Name | Text | Personalized communication |
| | Email Address | Email | Delivery |
| | Subscription Preferences | Multi-select | Blog updates, class info, events, general newsletter |
| | Consent to Receive Emails | Boolean | Legal compliance (e.g., GDPR) |
| | Date Subscribed | DateTime | Audit trail |
| | Unsubscribe Flag | Boolean | Manage mailing list |
| **Special Events** | RSVP Name | Text | Track attendees |
| | Email Address | Email | Send event details |
| | Event Type | Choice | Match to the event (e.g., Open Day, Holiday Workshop) |
| | Number of Attendees | Integer | Capacity planning |
| | Notes | Text area | Dietary needs, access info, etc. |
| | Consent to Follow-Up Email | Boolean | GDPR compliance |
| | RSVP Date | DateTime | Booking confirmation and sorting |
| **Admin & Analytics** | Submission Timestamp | DateTime (auto) | Track when data was received |
